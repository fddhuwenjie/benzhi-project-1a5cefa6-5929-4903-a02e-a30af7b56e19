...
func (s *Service) execute(id string, meta Meta, command any, successStatus int, mutate func(*store.Snapshot) (CommandResult, error)) (CommandResult, error) {
	return s.executeContext(context.Background(), id, meta, command, successStatus, mutate)
}
func (s *Service) executeContext(ctx context.Context, id string, meta Meta, command any, successStatus int, mutate func(*store.Snapshot) (CommandResult, error)) (CommandResult, error) {
...
func (s *Service) Freeze(id string, cmd FreezeProtocolCommand) (CommandResult, error) {
	return s.FreezeContext(context.Background(), id, cmd)
}
func (s *Service) FreezeContext(ctx context.Context, id string, cmd FreezeProtocolCommand) (CommandResult, error) {
	return s.executeContext(ctx, id, cmd.Meta, cmd, 200, func(snap *store.Snapshot) (CommandResult, error) {
		if snap.Case == nil {
